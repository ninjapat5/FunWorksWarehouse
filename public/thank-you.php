<?php
  ...
  $sql = "INSERT INTO message (FirstName,LastName,Email,Subject,Message) VALUES ('$FirstName','$LastName','$Email','$Subject','$Message')";
...
<html lang="en">
    <head>
      ...
      <title>FunWorks Warehouse | Thank You</title>
      <!--Custom Fonts-->
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                          ...
                          <li class="active-tab"><a href="contact.html">Contact</a></li>
                  </ul>
                </div>
              </div>
        </nav>
    <div class="section-primary-color v-align-parent"> 
      <div class="v-align-child">
        <div class="container text-center thank-you">
          <h1>Thanks!</h1>
          <p>We will get back with you shortly</p><a class="btn btn-primary btn-lg" href="index.html">Home</a>
        </div>
      </div>
    </div>
  </body>
